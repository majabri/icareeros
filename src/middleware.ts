...
// ─── Route lists ────────────────────────────────────────────────────────────
const PROTECTED = ["/dashboard", "/settings", "/opportunities", "/pipeline", "/profile", "/careerprofile", "/interview", "/evaluate", "/advise", "/learn", "/act", "/aicoach", "/personalcoach", "/achieve", "/offers", "/support", "/recruiter"];
