...
// ─── Route lists ────────────────────────────────────────────────────────────
const PROTECTED = ["/dashboard", "/settings", "/opportunities", "/pipeline", "/profile", "/careerprofile", "/interview", "/evaluate", "/advise", "/learn", "/act", "/coach", "/achieve", "/offers", "/support", "/recruiter"];
