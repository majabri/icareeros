  ...
  return (
    <nav style={{
      ...
      <div style={{
        ...
        <a href="/" style={{ display: "inline-flex", alignItems: "center", textDecoration: "none" }} aria-label="iCareerOS for Hiring — home">
          <Logo variant="horizontal" width={280} ariaLabel="iCareerOS for Hiring" />
        </a>
        ...
        <div style={{
          ...
          <ul style={{ listStyle: "none", margin: 0, padding: 0, display: "flex", flexDirection: "column", gap: "0" }}>
            ...
            <li style={{ marginTop: "1rem" }}>
              <a href="https://icareeros.com/auth/signup?role=employer" onClick={() => setMenuOpen(false)} style={{
