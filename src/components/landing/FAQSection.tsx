...
const FAQS = [
  ...
  { q:"Q: How is this different from just applying myself?",
    a:"You can apply manually and hope. Or use iCareerOS to apply 24/7 while you focus on interview prep and skill-building. The platform handles the mechanics so you can put your energy where it counts." },
  { q:"Q: What happens if no good roles match?",
    a:"Our AI continuously surfaces opportunities across your target categories, pulling from ATS feeds, RSS sources, and direct postings. If something truly isn't matching, we're transparent about it so you can adjust scope or criteria." },
  { q:"Q: Is my data safe?",
