      ...
      <div style={{ maxWidth:780, margin:"0 auto" }}>
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:"1.5rem", color:"var(--neutral-800)", fontSize:"1.1rem", lineHeight:1.75 }}>
          <p>
            ...
            job board. A coaching session. You buy one, you use it
            once, and then you&rsquo;re assembling the pieces yourself —
            hoping they talk to each other, knowing they won&rsquo;t.
          </p>
          <p>
            We built iCareerOS because careers need infrastructure, not
            tools. Infrastructure that runs continuously. That connects
            the evaluation to the application, the skill gap to the
            learning path, the interview prep to the offer. A loop that
            doesn&rsquo;t stop when you land a role — it resets for the
            next one.
          </p>
          <p>
            The same is true on the employer side. Hiring tools give
            you access to more people. iCareerOS gives you access to
            the right ones — candidates who are already in the loop,
            already preparing, already signalling intent by opting in
            to be found.
          </p>
          <p>
            Both sides of hiring are broken in the same way:
            disconnected, reactive, and built for transactions instead
            of outcomes. iCareerOS is the infrastructure that connects
            them.
          </p>
        </div>
      </div>
