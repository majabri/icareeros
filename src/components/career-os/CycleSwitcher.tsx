...
export function CycleSwitcher({ cycleId, userId }: CycleSwitcherProps) {
  ...
  return (
    <div ref={containerRef} className="relative inline-flex">
      ...
      >
        {/* Sprint 5 UX (2026-05-16) — Cycle #N badge removed from the pill.
            The goal alone is the user-facing label. The "Cycle #N" badge
            stays inside the dropdown rows (below) so users with multiple
            cycles can still distinguish them. */}
