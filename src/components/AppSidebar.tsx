...
export function AppSidebar({ mobileOpen, setMobileOpen }: Props) {
  ...
  return (
    <>
      ...
      >
        {/* Collapse toggle */}
        <div className="flex h-10 items-center justify-end px-3 border-b border-gray-100">
          <button
      ...
      {mobileOpen && (
        ...
        >
          {/* Drawer panel */}
          <div
            className="flex flex-col bg-white border-r border-gray-200 shadow-xl"
