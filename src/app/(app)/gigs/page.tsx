...
export const metadata: Metadata = { title: "Open Market — iCareerOS" };
  ...
  return (
    <div className="p-6 md:p-10 max-w-2xl">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-semibold text-gray-900 mb-2">🏪 Open Market</h1>
        <p className="text-gray-500 text-base leading-relaxed">Browse and bid on freelance projects, consulting gigs, and contract opportunities matched to your skills and rate.</p>
      </div>
