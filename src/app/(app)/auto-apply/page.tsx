...
export const metadata: Metadata = { title: "Autopilot Mode — iCareerOS" };
  ...
  return (
    <div className="p-6 md:p-10 max-w-2xl">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-semibold text-gray-900 mb-2">🤖 Autopilot Mode</h1>
        <p className="text-gray-500 text-base leading-relaxed">Set your criteria once and let iCareerOS automatically discover, score, and apply to matching jobs on your behalf — 24/7.</p>
      </div>
