...
export const metadata: Metadata = { title: "Flight Plan — iCareerOS" };
  ...
  return (
    <div className="p-6 md:p-10 max-w-2xl">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-semibold text-gray-900 mb-2">🗺️ Flight Plan</h1>
        <p className="text-gray-500 text-base leading-relaxed">Map your long-term career trajectory with AI guidance — identify gaps, set milestones, and get a step-by-step growth roadmap.</p>
      </div>
