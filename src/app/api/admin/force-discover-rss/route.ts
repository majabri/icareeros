/**
 * POST src/app/api/admin/force-discover-rss
 *
 * Sprint 4 W3-E — Admin trigger for /api/cron/discover-rss.
...
export async function POST(req: Request) {
  ...
  let upstreamBody = "";
  try {
    const res = await fetch(`${origin}/api/cron/discover-rss`, {
      method: "POST",
    ...
    await logAdminAction({
      ctx: r.ctx,
      action: "opportunities.rss_triggered",
