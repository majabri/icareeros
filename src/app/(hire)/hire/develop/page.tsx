...
export const metadata: Metadata = { title: "Develop — iCareerOS for Hiring" };

/**
 * Stage — Develop. Stub for Sprint H1.
 *
 ...
 */
export default function HireDevelopPage() {
  return (
    <div style={{ padding: "2rem 1.5rem", maxWidth: 800, margin: "0 auto" }}>
      <StageHeader stageId="develop" />
      <StageLocked stageId="develop" />
    </div>
  );
}
