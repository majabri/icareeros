...
export const metadata: Metadata = { title: "Integrate — iCareerOS for Hiring" };

/**
 * Stage — Integrate. Stub for Sprint H1.
 *
 ...
 */
export default function HireIntegratePage() {
  return (
    <div style={{ padding: "2rem 1.5rem", maxWidth: 800, margin: "0 auto" }}>
      <StageHeader stageId="integrate" />
      <StageLocked stageId="integrate" />
    </div>
  );
}
