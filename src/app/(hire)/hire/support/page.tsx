...
export const metadata: Metadata = { title: "Support — iCareerOS for Hiring" };

/**
 * Stage — Support. Stub for Sprint H1.
 *
 ...
 */
export default function HireSupportPage() {
  return (
    <div style={{ padding: "2rem 1.5rem", maxWidth: 800, margin: "0 auto" }}>
      <StageHeader stageId="support" />
      <StageLocked stageId="support" />
    </div>
  );
}
